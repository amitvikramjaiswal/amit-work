...
public class HomeFragment extends Fragment {
	...
	private TextView priceNotifyTV;
	private TextView newsNotifyTV;
	...
	private void setValues() {
		...
		int badge = preferences.getInt("BADGE", 0);
		if (badge == 0) {
			priceNotifyTV.setVisibility(View.GONE);
		} else {
			priceNotifyTV.setText(badge + "");
		}
	...
	private void initComponent() {
		...
		newsNotifyTV = (TextView) rootView.findViewById(R.id.news_notify_tv);
