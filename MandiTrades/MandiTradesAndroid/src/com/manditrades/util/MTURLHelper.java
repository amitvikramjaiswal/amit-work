...
public class MTURLHelper {
	...
	// + "/apimandi";
	private static String API_ENDPOINT_DEVELOPMENT = PRODUCTION_IP
			+ "/apimandi";
	...
	public static final String comodityURL = "/v1/?action=getCategory";
	...
	public static final String newsURL = "/v1/index.php/news_feed";
	public static final String submitGovtFeedbackURL = "/v1/index.php/schemes_feedback";
	...
	public static final String rateUserURL = "/v1/index.php/rating";
	public static final String interestedUserURL = "/v1/index.php/caller_insert";
	...
	public static final String deleteAccountURL = "/v1/index.php/delete";

	public static final String livePrices = "http://54.169.49.149/apimandi/v1/?";

	public static final String pushNotificationUrl = "/newpush.php/createEndpoint";
	public static final String getNotificationsUrl = "/v1/index.php/alerts_list_by_user";
	public static final String deleteNotificationUrl = "/v1/index.php/delete_single_alert";

	public static String getAPIEndpointURL(String requstedAPI) {
		return String.format("%s%s", API_ENDPOINT_DEVELOPMENT, requstedAPI);
	}

	public static String getAPIEndpointDevelopmentURL(String requstedAPI) {
		return String.format("%s%s", API_ENDPOINT_DEVELOPMENT, requstedAPI);
	}
