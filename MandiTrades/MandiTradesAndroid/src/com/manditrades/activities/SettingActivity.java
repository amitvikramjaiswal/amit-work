...
public class SettingActivity extends Activity {
	...
	private void setListeners() {
		...
		vegTogBtn.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				if (!vegTogBtn.isChecked()) {
					vegTogBtn.setChecked(true);
				}
			}
		});

		fruitsTogBtn.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				if (!fruitsTogBtn.isChecked()) {
					fruitsTogBtn.setChecked(true);
				}
			}
		});

		cerialsTogBtn.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				if (!cerialsTogBtn.isChecked()) {
					cerialsTogBtn.setChecked(true);
				}
			}
		});

		pulsesTogBtn.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				if (!pulsesTogBtn.isChecked()) {
					pulsesTogBtn.setChecked(true);
				}
			}
		});

		spicesTogBtn.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				if (!spicesTogBtn.isChecked()) {
					spicesTogBtn.setChecked(true);
				}
			}
		});
	}
	...
	private void initComponents() {
		...
		vegTogBtn = (ToggleButton) findViewById(R.id.tog_btn_veg);
		fruitsTogBtn = (ToggleButton) findViewById(R.id.tog_btn_fruits);
		cerialsTogBtn = (ToggleButton) findViewById(R.id.tog_btn_cerials);
		pulsesTogBtn = (ToggleButton) findViewById(R.id.tog_btn_pulses);
		spicesTogBtn = (ToggleButton) findViewById(R.id.tog_btn_spices);
