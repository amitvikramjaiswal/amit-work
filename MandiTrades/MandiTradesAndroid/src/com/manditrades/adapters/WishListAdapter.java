...
public class WishListAdapter extends BaseAdapter {
	...
	public WishListAdapter(Context context, ArrayList<MTSeller> mtSellerList,
			String source) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.wishlist_list_template,
					null);
		}
		...
		postedOnTV = (TextView) convertView.findViewById(R.id.tv3);
...
class WishListComparator implements Comparator<MTSeller> {
